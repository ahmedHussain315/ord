    ...
    constructor(props) {
      ...
      fomrSumbitter = ()=> {
        ...
        if(this.state.name !== "" && this.state.phone !== "" && this.state.address!==""){
            ...
            this.props.confirm_handler(lead,qty)
        }
        else{
            ...
            <div className='cart-form'>
              ...
              onBlur={this.form.handleBlurEvent} />
                    ...
                    <div className="qty" >
                        ...
                        <i onClick={()=>{this.qty_control("plus")}} className=" mx-3 pointer qty-action fas fa-plus-circle"></i></div> : null }
...
export default connect(mapStateToProps, {GET_PROD}) (CartForm);
